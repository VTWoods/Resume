...
\begin{resume}
%first sentance is what i am doing. second is what i have done
%Flesh out web development as ground breaking and relating to computer science education
\section{Summary} \textbf{\emph{Dedicated}} Software Engineer working on mission critical \textbf{\emph{Virtualization Security Systems}} to protect Cisco's \textbf{\emph{Virtualization Assets}}.  Previous experience creating innovative teaching environments to allow instructors to teach entry level Computer Science courses using \textbf{\emph{Web Development and Open Source Technologies}}.
...
\section{Employment}
        ...
        \begin{itemize}  \itemsep -2pt % reduce space between items
          \item Lead a technical proof of concept for a first generation binary security system
            \begin{itemize} \itemsep -2pt % reduce space between items
                ...
                \item Developed requirements for embeded system security gaps
                \item Designed a security system that generates a self protecting binary
                \item Presented final design to distinguished and principal engineers
                \item Integrated solution into the core architecture of Cisco's first generation virtual software router (CSR1000v)
                \item Scheduled to ship in Fall of 2012
            \end{itemize}
            ...
            \item Performed sustaining work for Cisco cloud software router
        ...
        \begin{itemize} \itemsep -2pt
            \item Primary architect and developer of the CloudSpace web devleopment environment
...
\section{Open Source \\ Contributions}
     ...
     \begin{itemize} \itemsep -2pt %reduce space between items
        ...
        \item \textbf{Arduino-IR-XBMC} - Perl script accepting Arduino generated infared commands
     \end{itemize}
     \pagebreak
