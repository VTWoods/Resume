...
\section{Employment}
        ...
        \begin{itemize}  \itemsep -2pt % reduce space between items
          \item Lead a technical proof of concept for a first generation binary security system
            \begin{itemize} \itemsep -2pt % reduce space between items
                ...
                \item Integrated the security solution into the core architecture of Cisco's first generation virtual software router (Cisco CSR1000v)
                \item Scheduled to ship with CSR1000v in Fall of 2012
            \end{itemize}
        ...
        \begin{itemize} \itemsep -2pt
            \item Primary architect and developer of the CloudSpace web development environment
